        ...
        <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl shadow-xl space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-h-32 overflow-y-auto scrollbar-thin">
              {styles.map((s) => (
                <button
                  key={s}
                  onClick={() => setStyle(s)}
                  className={`p-3 text-xs md:text-sm font-medium rounded-lg border transition-all ${
                    style === s
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className={`flex-[2] py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-3 transition-all ${
                loading || (!prompt && !refImage)
